...
const NeedofSp = () => {
  return (
    <div className='w-[95vw] p-2 sm:p-8 sm:w-[80vw] md:w-[65vw] flex flex-wrap justify-center gap-[3%] items-center bg-red-100 mb-12 rounded-md '>
        ...
        <div className='w-[200px] border  bg-red-500 border-black flex justify-center items-center  text-white p-2 rounded-lg cursor-pointer text-[1.5rem] '>lets talk</div>
    </div>
  )
}
