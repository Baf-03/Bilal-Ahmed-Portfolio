...
const NeedofSp = () => {
  return (
    <div  className='text-black w-[95vw] p-2 sm:p-8 sm:w-[80vw] md:w-[65vw] flex flex-wrap justify-center gap-[3%] items-center bg-red-100 mb-12 rounded-md '>
        ...
        <a href='https://wa.link/zlze49' target='_blank' className='w-[200px] border  bg-red-500 border-black flex justify-center items-center  text-white p-2 rounded-lg cursor-pointer lg:text-[1.5rem] my-5 sm:my-0 hover:bg-gray-300 hover:text-red-500 transition-colors duration-200 ease-in-out '>lets talk</a>
    </div>
  )
}
